...
public class LugusResourceCollectionDefault : ILugusResourceCollection
{
	...
	{	
		...
		if( output == null )
		{
			Debug.LogError("LugusResourceCollection: Texture " + key + " was not found under " + _URL + "!");
	...
	{	
		...
		if( output == null )
		{
			Debug.LogError("LugusResourceCollection: Sprite " + key + " was not found under " + _URL + "!");
	...
	public AudioClip GetAudio(string key)
	{
		...
		if( output == null )
		{
			Debug.LogError("LugusResourceCollection: AudioClip " + key + " was not found under " + _URL + "!");
	...
	public TextAsset GetTextAsset(string key)
	{
		...
		if( output == null )
		{
			Debug.LogError("LugusResourceCollection: TextAsset " + key + " was not found under " + _URL + "!");
...
public class LugusResourceCollectionLocalized : LugusResourceCollectionDefault
{
	...
	public string LangID
	{
		...
		{ 
			...
			Debug.Log ("LugusResourceCollectionLocalized: Changed language ID to " + _langID);
		}
	}
